...
export type ShallowListFragment = {
  id: string;
  name: string;
  todoCount: number;
  show: boolean;
...
export type AcceptListInviteMutation = {
  acceptListInvite: {
    id: string;
    name: string;
    todoCount: number;
...
export type InviteUserToListMutation = {
  inviteUserToList: {
    id: string;
    name: string;
    todoCount: number;
...
export type RemoveUserFromListMutation = {
  removeUserFromList: {
    id: string;
    name: string;
    todoCount: number;
...
export type GetListsForChipsQuery = {
  lists: Array<{
    id: string;
    name: string;
    todoCount: number;
...
export type UpdateListSortShowMutationVariables = Exact<{
  listIds: Array<string | number> | string | number;
}>;

export type UpdateListSortShowMutation = {
  updateListSortShow: Array<{
    id: string;
    name: string;
    todoCount: number;
    show: boolean;
...
export type DeleteTodoMutation = { deleteTodo: boolean | null };
...
export type UncheckCompletedTodosMutation = {
...
export const ListUserFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "ListUserObjectType" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
} as unknown as DocumentNode<ListUserFragment, unknown>;
export const ShallowListFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "ShallowList" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "ListObjectType" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "id" } },
          { kind: "Field", name: { kind: "Name", value: "name" } },
          { kind: "Field", name: { kind: "Name", value: "todoCount" } },
...
} as unknown as DocumentNode<ShallowListFragment, unknown>;
  ...
  definitions: [
    {
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "TodoObjectType" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
export const ListFullFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "ListFull" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "ListObjectType" },
      },
...
} as unknown as DocumentNode<ListFullFragment, unknown>;
export const AcceptListInviteDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AcceptListInvite" },
      variableDefinitions: [
        {
  ...
  AcceptListInviteMutation,
  AcceptListInviteMutationVariables
>;
...
export const InviteUserToListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "InviteUserToList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  InviteUserToListMutation,
  InviteUserToListMutationVariables
>;
export const RemoveUserFromListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RemoveUserFromList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "listUserId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
  ...
  RemoveUserFromListMutation,
  RemoveUserFromListMutationVariables
>;
export const GetListsForChipsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetListsForChips" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
export const UpdateListSortShowDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateListSortShow" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  UpdateListSortShowMutation,
  UpdateListSortShowMutationVariables
>;
...
export const DeleteCompletedTodosDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteCompletedTodos" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  DeleteCompletedTodosMutationVariables
>;
export const UncheckCompletedTodosDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UncheckCompletedTodos" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  UncheckCompletedTodosMutationVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "settingGroupCompleted" },
                },
              ],
            },
          },
